...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Canvas_Canvas__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_createElement__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_field2Text__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_addElementEventListener__ = __webpack_require__(6);
...
class App {
    constructor(container, numOne, numTwo) {
        ...
        this.numOne = numOne;
        this.numTwo = numTwo;
        this.app = Object(__WEBPACK_IMPORTED_MODULE_1__utils_createElement__["a" /* createElement */])(this.container, 'div', 'app');

        this.task = Object(__WEBPACK_IMPORTED_MODULE_1__utils_createElement__["a" /* createElement */])(this.app, 'div', 'task');

        this.termOne = Object(__WEBPACK_IMPORTED_MODULE_1__utils_createElement__["a" /* createElement */])(this.task, 'span');
        this.termOne.innerText = this.numOne;
        this.plus = Object(__WEBPACK_IMPORTED_MODULE_1__utils_createElement__["a" /* createElement */])(this.task, 'span');
        this.plus.innerText = ' + ';
        this.termTwo = Object(__WEBPACK_IMPORTED_MODULE_1__utils_createElement__["a" /* createElement */])(this.task, 'span');
        this.termTwo.innerText = this.numTwo;
        this.equally = Object(__WEBPACK_IMPORTED_MODULE_1__utils_createElement__["a" /* createElement */])(this.task, 'span');
        this.equally.innerText = ' = ';
        this.ammount_span = Object(__WEBPACK_IMPORTED_MODULE_1__utils_createElement__["a" /* createElement */])(this.task, 'span');
        this.ammount_span.innerText = '?';

        this.ammount_input = document.createElement('input');
        this.ammount_input.size = 2;
        Object(__WEBPACK_IMPORTED_MODULE_3__utils_addElementEventListener__["a" /* addElementEventListener */])(this.ammount_input, 'input', event => {
            this.ammount_span.innerText = this.numOne + this.numTwo;
            Object(__WEBPACK_IMPORTED_MODULE_2__utils_field2Text__["a" /* inputText */])(event, this.ammount_span, () => {
                console.log('Конец');
            });
        });

        this.canvas = new __WEBPACK_IMPORTED_MODULE_0__Canvas_Canvas__["a" /* Canvas */](this.app);
        ...
        Object(__WEBPACK_IMPORTED_MODULE_3__utils_addElementEventListener__["a" /* addElementEventListener */])(this.inputTwo, 'input', event => {
            Object(__WEBPACK_IMPORTED_MODULE_2__utils_field2Text__["a" /* inputText */])(event, this.termTwo, () => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_createElement__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sprite_png__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sprite_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__sprite_png__);
...
class Canvas {
    constructor(container) {
        ...
        this.promise = new Promise(resolve => {
            ...
            img.src = 'static/' + __WEBPACK_IMPORTED_MODULE_1__sprite_png___default.a;
        });
...
module.exports = __webpack_require__.p + "236a2c3aaf9d64cf6bf6f5daea4e029e.png";
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = inputText;
function field2Text(field) {
    field.classList.add('clearInput');
    field.setAttribute('readonly', 'true');
}

function inputText(event, number, callback) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = addElementEventListener;
...
// module
exports.push([module.i, ".erroreInput{\n    color: #f00;\n    outline-color: #f00;\n}\n.clearInput{\n    border: 0;\n    outline: 0;\n}\n\n.erroreNumber{\n    background-color: #FF0;\n}\n\n.task{\n    text-align: center;\n}\n\n.task span, .task input{\n    font-size: 2em;\n    font-weight: bold;\n}\n\n.input{\n    font-size: 1.5em;\n}", ""]);
